...
ActiveRecord::Schema.define(version: 20170428180908) do
  ...
  create_table "stocks", force: :cascade do |t|
    ...
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
    t.string   "stockholder_type"
    t.integer  "stockholder_id"
    t.index ["stockholder_type", "stockholder_id"], name: "index_stocks_on_stockholder_type_and_stockholder_id", using: :btree
  end
